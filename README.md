...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/yuanzheliu-ucsb/macro/main)
...
git branch -M main
git remote add origin https://github.com/yuanzheliu-ucsb/macro.git
